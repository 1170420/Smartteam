...
public class WebSocketService {
    ...
    private static List<Session> sessList = new ArrayList<Session>();
...
//		}
//		System.out.println("asd:"+flag);
//		System.out.println("iop:"+member);
//		
//	}
	...
	public void onMessage(String message,Session session) throws IOException{
		...
		String content = JSONObject.fromObject(message).getString("content");
		for(Session sess : sessList){
			sess.getAsyncRemote().sendText(content);
		}
		//把用户发来的消息解析为JSON对象
