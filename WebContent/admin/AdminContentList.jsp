...
<div id="toolbar" >
    ...
    <button id="content_update" type="button" class="btn btn-success" style="width: 300px;">
        <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;修改需求信息
    </button>
     <button id="content_delete" type="button" class="btn btn-danger" style="width: 300px;">
